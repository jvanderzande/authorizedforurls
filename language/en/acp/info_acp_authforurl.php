...
$lang = array_merge($lang, [
	// ACP
	'AFU_ACP_TITLE'			=> 'Authorized for URLs & Words',
	'AFU_CONFIG'			   => 'Settings',
	...
	'AFU_WORDS'				   => 'The WORDS’s to check for',
	'AFU_WORDS_EXPLAIN'		=> 'The WORDS to filter on, seperated by a comma (Example: shein,coupons,gamble).',
	'AFU_WORDCNT'				=> 'The allowed word hits',
	'AFU_WORDCNT_EXPLAIN'	=> 'When the hit count exceeds the number, the post will be denied.<br>0 means word checking is disabled.',
	...
	'REQUIREMENTS_NT_MET'	=> 'This extension requires at least PHP version 7.3.0 and phpBB version 3.3.0 or higher.  Please update your PHP version and/or your phpBB version in order to use the extension.',
]);
